     ...
     <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
              ...
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  ...
                  <span className="block text-gray-500">Total Exchanges</span>
                </div>
              </div>
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  ...
                  <span className="block text-gray-500">Your Trending Books</span>
                </div>
              </div>
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                <div className="inline-flex flex-shrink-0 items-center justify-center h-16 w-16 text-blue-600 bg-blue-100 rounded-full mr-6">
                <MdStarRate className='size-6 text-yellow-500'/>
                </div>
                <div >
                  <div className="flex space-x-1">
                <MdStarRate className='size-4 text-yellow-500'/>
                <MdStarRate className='size-4 text-yellow-500'/>
                <MdStarRate className='size-4 text-yellow-500'/>
                <MdStarRate className='size-4 text-yellow-500'/>
                </div>
                  <span className="block text-gray-500">Your rating</span>
                </div>
              </div>
            </section>
